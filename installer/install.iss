...
[Icons]
Name: "{autoprograms}\{#MyAppName}"; Filename: "{app}\conemu\ConEmu64.exe"; Parameters: "-icon {app}\icon.ico -run {app}\usr\bin\bash.exe -l -i"; IconFilename: "{app}\icon.ico"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\conemu\ConEmu64.exe"; Parameters: "-icon {app}\icon.ico -run {app}\usr\bin\bash.exe -l -i"; IconFilename: "{app}\icon.ico"; Tasks: desktopicon
